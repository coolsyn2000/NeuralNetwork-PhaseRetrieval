...
def test():
    ...
    preds_generator = generator_model(x)
    preds_discriminator = discriminator_model(x,y)

    print("output of generator: ", preds_generator.shape)
    print("output of discriminator: ", preds_discriminator.shape)
